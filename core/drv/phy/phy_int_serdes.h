...
yt_ret_t int_serdes_green_enable_set(yt_unit_t, uint8_t, yt_enable_t);
yt_ret_t int_serdes_green_enable_get(yt_unit_t, uint8_t, yt_enable_t *);
yt_ret_t int_serdes_parallel_detection_set(yt_unit_t, uint8_t, yt_enable_t);
yt_ret_t int_serdes_parallel_detection_get(yt_unit_t, uint8_t, yt_enable_t *);
yt_ret_t int_serdes_utp_snr_get(yt_unit_t, uint8_t, yt_port_speed_t, yt_utp_snr_t *);
#endif