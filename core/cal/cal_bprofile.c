...
#endif
#if defined(BOARD_YT9218MB_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
#include "bprofile_YT9218MB_default_demo.c"
#endif
#if defined(BOARD_YT9214NB_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
#include "bprofile_YT9214NB_default_demo.c"
#endif
#if defined(BOARD_YT9213NB_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
#include "bprofile_YT9213NB_default_demo.c"
#endif
#if defined(BOARD_YT9218MB_YT8531_DEMO) || defined(BOARD_AUTO_DETECT)
#include "bprofile_YT9218MB_YT8531_demo.c"
#endif
#if defined(BOARD_YT9218N_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
#include "bprofile_YT9218N_default_demo.c"
#endif
#if defined(BOARD_YT921X_MULTI_SW_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
#include "bprofile_YT921X_multi_sw_default_demo.c"
#endif
/*
...
#endif
#if defined(BOARD_YT9218MB_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
    &yt9218mb_default_demo,
#endif
#if defined(BOARD_YT9214NB_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
    &yt9214nb_default_demo,
#endif
#if defined(BOARD_YT9213NB_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
    &yt9213nb_default_demo,
#endif
#if defined(BOARD_YT9218MB_YT8531_DEMO) || defined(BOARD_AUTO_DETECT)
    &yt9218mb_yt8531_demo,
#endif
#if defined(BOARD_YT9218N_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
    &yt9218n_default_demo,
#endif
#if defined(BOARD_YT921X_MULTI_SW_DEFAULT_DEMO) || defined(BOARD_AUTO_DETECT)
    &yt921x_multi_sw_default_demo,
#endif
    NULL
};
