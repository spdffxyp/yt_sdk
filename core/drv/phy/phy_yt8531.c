...
yt_phy_drv_func_t yt8531_drv_func =
{
    ...
    .phy_green_enable_set = yt8531_green_enable_set,
    .phy_green_enable_get = yt8531_green_enable_get,
    .phy_parallel_detection_set = yt8531_parallel_detection_set,
    .phy_parallel_detection_get = yt8531_parallel_detection_get,
    .phy_utp_snr_get = yt8531_utp_snr_get,
};
...
yt_ret_t yt8531_green_enable_set(yt_unit_t unit, uint8_t phy_addr, yt_enable_t enable)
{
    CMM_UNUSED_PARAM(unit);
    CMM_UNUSED_PARAM(phy_addr);
...
yt_ret_t yt8531_green_enable_get(yt_unit_t unit, uint8_t phy_addr, yt_enable_t *pEnable)
{
    CMM_UNUSED_PARAM(unit);
    CMM_UNUSED_PARAM(phy_addr);
...
yt_ret_t yt8531_parallel_detection_set(yt_unit_t unit, uint8_t phy_addr, yt_enable_t enable)
{
    CMM_UNUSED_PARAM(unit);
    CMM_UNUSED_PARAM(phy_addr);
    CMM_UNUSED_PARAM(enable);
...
yt_ret_t yt8531_parallel_detection_get(yt_unit_t unit, uint8_t phy_addr, yt_enable_t *pEnable)
{
    CMM_UNUSED_PARAM(unit);
    CMM_UNUSED_PARAM(phy_addr);
    CMM_UNUSED_PARAM(pEnable);
...
yt_ret_t yt8531_utp_snr_get(yt_unit_t unit, uint8_t phy_addr, yt_port_speed_t speed, yt_utp_snr_t *pSnrVal)
{
    CMM_UNUSED_PARAM(unit);
    CMM_UNUSED_PARAM(phy_addr);
