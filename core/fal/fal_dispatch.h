...
typedef struct fal_dispatch_s 
{
    ...
    yt_ret_t (*l2_fdb_ucast_addr_add_dynamic)(yt_unit_t, yt_vlan_t, yt_mac_addr_t, yt_port_t, yt_bool_t);
    ...
    yt_ret_t (*l2_mcast_addr_withindex_get)(yt_unit_t, uint16_t, l2_mcastMacAddr_info_t *);
    yt_ret_t (*l2_mcast_addr_withMacAndVid_get)(yt_unit_t, yt_vlan_t, yt_mac_addr_t, l2_mcastMacAddr_info_t *);
    yt_ret_t (*l2_mcast_addr_withindex_getnext)(yt_unit_t, uint16_t, uint16_t *, l2_mcastMacAddr_info_t *);
    ...
    yt_ret_t (*port_phy_green_enable_set)(yt_unit_t, yt_port_t,  yt_enable_t);
    yt_ret_t (*port_phy_green_enable_get)(yt_unit_t, yt_port_t,  yt_enable_t *);
    ...
    yt_ret_t (*port_dvddio_power_level_set)(yt_unit_t unit, uint32_t powerPad, yt_dvddio_power_level_t powerLevel);
    yt_ret_t (*port_dvddio_power_level_get)(yt_unit_t unit, uint32_t powerPad, yt_dvddio_power_level_t *pPowerLevel);
