...
/**
 * @internal      yt_vlan_protocol_based_vlan_group_set
 * @endinternal
 *
 * @brief         Set protocol vlan group config
 * @note          APPLICABLE DEVICES  -Tiger
 * @param[in]     unit                -unit id
 * @param[in]     group_id           -group id
 * @param[in]     key                 -yt_vlan.h
 * @retval        CMM_ERR_OK          -on success
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t  yt_vlan_protocol_based_vlan_group_set(yt_unit_t unit, uint8_t group_id, yt_vlan_protocol_key_t key)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);

    return YT_DISPATCH(unit)->vlan_protocol_based_vlan_group_set(unit, group_id, key);
}

/**
 * @internal      yt_vlan_protocol_based_vlan_group_get
 * @endinternal
 *
 * @brief         Get protocol vlan group config
 * @note          APPLICABLE DEVICES  -Tiger
 * @param[in]     unit                -unit id
 * @param[in]     group_id           -group id
 * @param[out]    pKey                -yt_vlan.h
 * @retval        CMM_ERR_OK          -on success
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t  yt_vlan_protocol_based_vlan_group_get(yt_unit_t unit, uint8_t group_id, yt_vlan_protocol_key_t *pKey)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    return YT_DISPATCH(unit)->vlan_protocol_based_vlan_group_get(unit, group_id, pKey);
}

/**
 * @internal      yt_vlan_protocol_based_vlan_table_set
 * @endinternal
 *
 * @brief         Set protocol vlan table config
 * @note          APPLICABLE DEVICES  -Tiger
 * @param[in]     unit                -unit id
 * @param[in]     port                -port num
 * @param[in]     group_id           -group id
 * @param[in]     action              -yt_vlan.h
 * @retval        CMM_ERR_OK          -on success
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t  yt_vlan_protocol_based_vlan_table_set(yt_unit_t unit, yt_port_t port, uint8_t group_id, yt_vlan_protocol_action_t action)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    return YT_DISPATCH(unit)->vlan_protocol_based_vlan_table_set(unit, port, group_id, action);
}

/**
 * @internal      yt_vlan_protocol_based_vlan_table_get
 * @endinternal
 *
 * @brief         Get protocol vlan table config 
 * @note          APPLICABLE DEVICES  -Tiger
 * @param[in]     unit                -unit id
 * @param[in]     port                -port num
 * @param[in]     group_id           -group id
 * @param[out]    pAction             -yt_vlan.h
 * @retval        CMM_ERR_OK          -on success
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t  yt_vlan_protocol_based_vlan_table_get(yt_unit_t unit, yt_port_t port, uint8_t  group_id, yt_vlan_protocol_action_t *pAction)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    return YT_DISPATCH(unit)->vlan_protocol_based_vlan_table_get(unit, port, group_id, pAction);
}

/**
 * @internal      yt_vlan_protocol_based_vlan_table_del
 * @endinternal
 *
 * @brief         Del protocol vlan table config
 * @note          APPLICABLE DEVICES  -Tiger
 * @param[in]     unit                -unit id
 * @param[in]     port                -port num
 * @param[in]     group_id           -group id
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t  yt_vlan_protocol_based_vlan_table_del(yt_unit_t unit, yt_port_t port, uint8_t  group_id)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    return YT_DISPATCH(unit)->vlan_protocol_based_vlan_table_del(unit, port, group_id);
}