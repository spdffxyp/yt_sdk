...
{
    yt_l2_type_t l2_type;
    uint16_t eth_type; /*eth type value*/
    yt_bool_t key_valid; /*set TRUE to enable this protocol vlan key entry,and set FALSE to disable this protocol vlan key entry*/
}yt_vlan_protocol_key_t;

typedef struct yt_vlan_protocol_action_s 
{
    uint16_t cvid;
    yt_vlan_trans_action_t cvlan_action;
    uint16_t svid;
    yt_vlan_trans_action_t svlan_action;
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  yt_vlan_protocol_based_vlan_group_set(yt_unit_t unit, uint8_t group_id, yt_vlan_protocol_key_t key);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  yt_vlan_protocol_based_vlan_group_get(yt_unit_t unit, uint8_t group_id, yt_vlan_protocol_key_t *pKey);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  yt_vlan_protocol_based_vlan_table_set(yt_unit_t unit, yt_port_t port, uint8_t group_id, yt_vlan_protocol_action_t action);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  yt_vlan_protocol_based_vlan_table_get(yt_unit_t unit, yt_port_t port, uint8_t  group_id, yt_vlan_protocol_action_t *pAction);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  yt_vlan_protocol_based_vlan_table_del(yt_unit_t unit, yt_port_t port, uint8_t  group_id);
