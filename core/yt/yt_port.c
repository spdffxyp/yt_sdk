...
yt_ret_t yt_port_extif_mode_set(yt_unit_t unit, yt_port_t port, yt_extif_mode_t mode)
{
    ...
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(CMM_PORT_VALID(unit, port))), CMM_ERR_PORT);
    CMM_PARAM_CHK((YT_EXTIF_MODE_SGFIB_AS < mode || YT_EXTIF_MODE_MII > mode), CMM_ERR_INPUT);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t yt_port_phy_green_enable_set(yt_unit_t unit, yt_port_t port, yt_enable_t enable)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    CMM_PARAM_CHK((YT_ENABLE < enable || YT_DISABLE > enable), CMM_ERR_INPUT);
     ...
     return YT_DISPATCH(unit)->port_phy_green_enable_set(unit, port, enable);
}
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
 yt_ret_t yt_port_phy_green_enable_get(yt_unit_t unit, yt_port_t port, yt_enable_t *pStatus)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    CMM_PARAM_CHK((NULL == pStatus), CMM_ERR_NULL_POINT);
     ...
     return YT_DISPATCH(unit)->port_phy_green_enable_get(unit, port, pStatus);
}
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t yt_port_parallel_detection_set(yt_unit_t unit, yt_port_t port, yt_enable_t state)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    return YT_DISPATCH(unit)->port_parallel_detection_set(unit, port, state);
}
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
yt_ret_t yt_port_parallel_detection_get(yt_unit_t unit, yt_port_t port, yt_enable_t *pState)
{
    CMM_PARAM_CHK((YT_UNIT_NUM <= unit), CMM_ERR_INPUT);
    CMM_PARAM_CHK(NULL == YT_DISPATCH(unit), CMM_ERR_NOT_INIT);
    CMM_PARAM_CHK((!(YT_DISPATCH(unit)->is_inited)), CMM_ERR_NOT_INIT);
    ...
    return YT_DISPATCH(unit)->port_parallel_detection_get(unit, port, pState);
}
