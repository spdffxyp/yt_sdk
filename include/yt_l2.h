...
typedef struct l2_mcastMacAddr_info_s
{
    yt_vlan_t vid;
    yt_mac_addr_t macaddr;
    yt_port_mask_t portMask;
    yt_l2_fdb_type_t type; /*invalid, static, pending, dynamic*/
}l2_mcastMacAddr_info_t;
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  yt_l2_fdb_ucast_addr_add_dynamic(yt_unit_t unit, yt_vlan_t vid, yt_mac_addr_t mac_addr, yt_port_t port, yt_bool_t isLag);
 ...
 * @retval        CMM_ERR_ENTRY_NOT_FOUND -no valid mac entry on this index next
 */
extern yt_ret_t yt_l2_mcast_addr_withindex_get(yt_unit_t unit, uint16_t index, l2_mcastMacAddr_info_t *pMcastMac);
 ...
 * @retval        CMM_ERR_ENTRY_NOT_FOUND -no valid mac entry on this index next
 */
extern yt_ret_t yt_l2_mcast_addr_withMacAndVid_get(yt_unit_t unit, yt_vlan_t vid, yt_mac_addr_t mac_addr, l2_mcastMacAddr_info_t *pMcastMac);
 ...
 * @retval        CMM_ERR_ENTRY_NOT_FOUND -no valid mac entry on this index next
 */
extern yt_ret_t  yt_l2_mcast_addr_withindex_getnext(yt_unit_t unit, uint16_t index, uint16_t *pNext_index, l2_mcastMacAddr_info_t *pMcastMac);
