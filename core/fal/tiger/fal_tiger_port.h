...
/**
 * @internal      fal_tiger_port_phyGreen_enable_set
 * @endinternal
 *
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t fal_tiger_port_phyGreen_enable_set(yt_unit_t unit, yt_port_t port, yt_enable_t enable);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t fal_tiger_port_phyGreen_enable_get(yt_unit_t unit, yt_port_t port, yt_enable_t *pEnable);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t fal_tiger_port_parallel_detection_set(yt_unit_t unit, yt_port_t port,yt_enable_t state);
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t fal_tiger_port_parallel_detection_get(yt_unit_t unit, yt_port_t port,yt_enable_t *pState);
