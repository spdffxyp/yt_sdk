...
/**
 * @internal      fal_tiger_vlan_protocol_based_vlan_group_set
 * @endinternal
 *
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  fal_tiger_vlan_protocol_based_vlan_group_set(yt_unit_t unit, uint8_t group_id, yt_vlan_protocol_key_t key);

/**
 * @internal      fal_tiger_vlan_protocol_based_vlan_group_get
 * @endinternal
 *
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  fal_tiger_vlan_protocol_based_vlan_group_get(yt_unit_t unit, uint8_t group_id, yt_vlan_protocol_key_t *pKey);

/**
 * @internal      fal_tiger_vlan_protocol_based_vlan_table_set
 * @endinternal
 *
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  fal_tiger_vlan_protocol_based_vlan_table_set(yt_unit_t unit, yt_port_t port, uint8_t group_id, yt_vlan_protocol_action_t action);

/**
 * @internal      fal_tiger_vlan_protocol_based_vlan_table_get
 * @endinternal
 *
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  fal_tiger_vlan_protocol_based_vlan_table_get(yt_unit_t unit, yt_port_t port, uint8_t  group_id, yt_vlan_protocol_action_t *pAction);

/**
 * @internal      fal_tiger_vlan_protocol_based_vlan_table_del
 * @endinternal
 *
 ...
 * @retval        CMM_ERR_FAIL        -on fail
 */
extern yt_ret_t  fal_tiger_vlan_protocol_based_vlan_table_del(yt_unit_t unit, yt_port_t port, uint8_t  group_id);
