...
fal_dispatch_t  fal_tiger_dispatch = 
{
    ...
    .l2_fdb_ucast_addr_add_dynamic = fal_tiger_l2_fdb_ucast_addr_add_dynamic,
    ...
    .l2_mcast_addr_withindex_get = fal_tiger_l2_mcast_addr_withindex_get,
    .l2_mcast_addr_withMacAndVid_get = fal_tiger_l2_mcast_addr_withMacAndVid_get,
    .l2_mcast_addr_withindex_getnext = fal_tiger_l2_mcast_addr_withindex_getnext,
    ...
    .port_phy_green_enable_set = fal_tiger_port_phyGreen_enable_set,
    .port_phy_green_enable_get = fal_tiger_port_phyGreen_enable_get,
